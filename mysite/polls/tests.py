...
def create_question(question_test, days):
    """
    Create a question with the given 'question_test' and published the given number of days offset to now (negative for questions published in the past, positive for questions that have yet to be publshed)
